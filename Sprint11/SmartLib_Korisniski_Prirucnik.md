...
4. [Pregled ekrana po ulogama](#4-pregled-ekrana-po-ulogama)
5. [Korak-po-korak upute](#5-korak-po-korak-upute)
6. [Notifikacije](#6-notifikacije)
7. [Ograničenja sistema](#7-ograničenja-sistema)
8. [Cešta pitanja](#8-cesta-pitanja)
...
- **Čitaocima (članovima biblioteke)** koji zele pregledavati katalog, posuditi knjige, pratiti zaduženja i ucestvovati u zajednici
...
- Katalog s vise od stotinu naslova i naprednom pretragom
...
- PDF izvještaji za upravljacko osoblje
- Kompletni audit log za administratore

![Početna stranica SmartLib](screenshots/01-početna.png)
...
SmartLib razlikuje tri korisničke uloge. Svaka uloga ima drugaciji prikaz sistema i drugaciji set mogucnosti.
...
**Može:**
- Pretragivati i pregledavati katalog knjiga
...
Nakon uspjesne prijave sistem vas preusmjerava prema ulozi:
- **Član:** personalizirana početna stranica s preporukama knjiga
- **Bibliotekar:** upravljačka ploca s pregledom aktivnosti
- **Administrator:** upravljačka ploca s punim pristupom
...
## 4. Pregled ekrana po ulogama

### 4.1 Javne stranice (bez prijave)
...
*Slika 4.2 - Interaktivni kalendar događaja*

### 4.2 Ekrani za člana

#### Početna stranica (član)

Personalizirana početna s preporucenim knjigama na osnovu historije čitanja, vijestima i nadolazečim događajima.

![Početna - član](screenshots/05-član-početna.png)
*Slika 4.3 - Personalizirana početna stranica člana*
...
*Slika 4.4 - Katalog knjiga s filterima*

#### Detalji knjige

Opis, ISBN, kategorija, dostupni primjerci i recenzije čitalaca. Mogucnost rezervacije i dodavanja u kolekciju.

![Detalji knjige](screenshots/07-knjiga-detalji.png)
*Slika 4.5 - Stranica s detaljima knjige*

#### Moja zaduženja

Lišta posudjenih knjiga s datumima posudbe i rokovima vraćanja. zakašnjena zaduženja su istaknuta.

![Moja zaduženja](screenshots/08-moja-zaduženja.png)
*Slika 4.6 - Pregled aktivnih zaduženja*
...
*Slika 4.8 - Tematske kolekcije knjiga*
...
*Slika 4.9 - Forum zajednice*

#### Notifikacije

Sve obavijesti sistema s mogucnoscu označavanja kao pročitano.

![Notifikacije](screenshots/12-notifikacije.png)
*Slika 4.10 - Centar notifikacija*

#### Moj profil

Licni podaci, status članarine, historija čitanja i postignute znacajke.

![Profil](screenshots/13-profil.png)
*Slika 4.11 - Korisnički profil člana*

### 4.3 Ekrani za bibliotekara

#### Aktivna zaduženja

Sva tekuca zaduženja s filtriranjem po članovima. zakašnjena su istaknuta crvenom bojom.

![Sva zaduženja](screenshots/15-sva-zaduženja.png)
*Slika 4.12 - Aktivna zaduženja (bibliotekar)*

#### Lišta članova

Svi registrovani članovi s pretragom i opcijama upravljanja.

![Članovi](screenshots/18-članovi.png)
*Slika 4.13 - Lišta članova biblioteke*

#### Zahtjevi za produženje

Pregled zahtjeva za produženje članarine s opcijama odobravanja ili odbijanja.

![Produženje](screenshots/22-produženje.png)
*Slika 4.14 - Zahtjevi za produženje članarine*

#### Izvještaji

PDF izvještaji o zaduženjima, rezervacijama i članovima za odabrani period.

![Izvještaji](screenshots/21-izvještaji.png)
*Slika 4.15 - Generisanje izvještaja*

### 4.4 Ekrani za administratora
...
*Slika 4.16 - Lišta bibliotekarskih naloga*
...
*Slika 4.17 - Audit log (samo za administratore)*

---

## 5. Korak-po-korak upute

### 5.1 Pretraga i posudba knjige (Član)
...
4. Po potrebi koristite filtere: kategorija, izdavac, godina
...
**Očekivani rezultat:** Knjiga se pojavljuje u sekciji "Moja zaduženja" s datumom posudbe i rokom vraćanja (standardno 14 dana).

---

### 5.2 Rezervacija nedostupne knjige (Član)
...
### 5.4 Kreiranje kolekcije knjiga (Član)
...
### 5.5 Sudjelovanje u forumu (Član i Bibliotekar)
...
### 5.6 Zaduživanje knjige (Bibliotekar)
...
![Novo zaduženje](screenshots/16-novo-zaduženje.png)
*Slika 5.1 - Forma za registraciju novog zaduženja*

---

### 5.7 Vraćanje knjige (Bibliotekar)
...
### 5.8 Registracija novog člana (Bibliotekar)
...
![Novi član](screenshots/19-novi-član.png)
*Slika 5.2 - Forma za registraciju novog člana*

---

### 5.9 Dodavanje knjige u katalog (Bibliotekar)
...
### 5.10 Odobravanje produženja članarine (Bibliotekar)
...
### 5.11 Generisanje izvještaja (Bibliotekar)
...
![Izvještaji](screenshots/21-izvještaji.png)
*Slika 5.3 - Stranica za generisanje izvještaja*

---

### 5.12 Upravljanje bibliotekarima (Administrator)
...
### 5.13 Pregled audit loga (Administrator)
...
![Audit log](screenshots/27-audit-log.png)
*Slika 5.4 - Audit log s filterima*
