...
| PB-25 | Brisanje knjige i deaktivacija primjerka | Bibliotekar ili administrator može ukloniti knjigu ili deaktivirati primjerak iz sistema | Feature | Srednji | S | U backlogu | Sprint 6 | Ne briše se ako postoji aktivno zaduženje |
| PB-26 | Upravljanje kategorijama knjiga | Admin dodaje, uređuje i briše kategorije koje se koriste pri dodavanju knjiga | Feature | Srednji | S | U backlogu | Sprint 6 | Preduslov za kategorisanje knjiga |
| PB-27 | Pregled historije zaduženja | Sistem prikazuje ranija zaduženja člana | Feature | Nizak | M | U backlogu | Sprint 8 | Nadogradnja evidencije |
| PB-28 | Početno testiranje | Testiranje prve verzije sistema | Technical task | Nizak | M | U backlogu | Sprint 8 | Napredna sigurnost |
| PB-29 | Rezervacija knjige | Član ili bibliotekar može rezervisati nedostupnu knjigu | Feature | Srednji | M | U backlogu | Sprint 9 | Zavisi od dostupnosti |
| PB-30 | Pregled aktivnih rezervacija | Bibliotekar vidi listu aktivnih rezervacija | Feature | Srednji | M | U backlogu | Sprint 9 | Nad rezervacijama |
| PB-31 | Slanje email podsjetnika | Sistem automatski šalje podsjetnike za rok vraćanja | Feature | Nizak | M | U backlogu | Sprint 10 | Nadogradnja |
| PB-32 | Slanje email upozorenja | Sistem automatski šalje podsjetnike za istek roka vraćanja | Feature | Nizak | M | U backlogu | Sprint 10 | Nadogradnja |
| PB-33 | Notifikacija bibliotekara o novoj rezervaciji | Bibliotekar dobija email obavijest kada član kreira rezervaciju | Feature | Nizak | S | U backlogu | Sprint 10 | Zavisi od email sistema |
| PB-34 | Automatsko otkazivanje rezervacije | Ako član ne preuzme knjigu u roku X dana, rezervacija se automatski otkazuje | Feature | Nizak | M | U backlogu | Sprint 10 | Zavisi od CRON joba i poslovnog pravila |
| PB-35 | Napredna pretraga i filteri | Filtriranje po žanru, godini, izdavaču i slično | Feature | Nizak | M | U backlogu | Sprint 9 | Poboljšanje UX |
| PB-36 | Mjesečni izvještaji za upravu | Pregled statistike zaduženja, rezervacija i članstva | Feature | Nizak | L | U backlogu | Sprint 10 | Analitika |
| PB-37 | Audit log promjena | Evidencija važnih promjena u sistemu | Technical task | Nizak | M | U backlogu | Sprint 10 | Napredno praćenje |
| PB-38 | Kazne za kasno vraćanje | Evidencija i obračun kazni za prekoračenje roka vraćanja | Feature | Nizak | M | U backlogu | Sprint 10 | Ovisi o notifikacionom sistemu i poslovnoj politici |
| PB-39 | Online produžetak članarine | Omogućiti korisniku produženje članarine putem sistema | Feature | Nizak | M | U backlogu | Sprint 10 | Zahtijeva integraciju sistema za online plaćanje |
| PB-40 | Integracija sa distributerom knjiga | Povezivanje sistema sa vanjskim servisom za nabavku knjiga | Technical Task | Nizak | L | U backlogu | Sprint 10 |   |
| PB-41 | Stabilizacija sistema | Bug fixing i optimizacija | Technical task | Visok | M | U backlogu | Sprint 11 | Nakon početnog testiranja |
| PB-42 | Izrada liste pozatih ograničenja i tehničkog dugog | Popis ograničenja i nedovršenih dijelova | Documentation| Visok | M | U backlogu | Sprint 11 |  |
| PB-43 | Release Notes | Opis funkcionalnosti kroz verzije | Documentation | Visok | M | U backlogu | Sprint 12 |  |
| PB-44 | Korisnička dokumentacija | Izrada dokumentacije za upotrebu | Documentation | Visok | M | U backlogu | Sprint 12 | Bez tehničkih dijelova |
| PB-45 | Tehnička dokumentacija | Izrada dokumentacije za opis sistema | Documentation | Visok | M | U backlogu | Sprint 12 | Detaljan opis |
| PB-45 | Završna demonstracija | Finalizacija projekta | Documentation | Visok | M | U backlogu | Sprint 13 |  |
