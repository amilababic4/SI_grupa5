...
Ovaj dokument predstavlja ažurirani Product Backlog projekta **Bibliotečki informacioni sistem** u sklopu Sprint 6. Backlog sadrži stavke koje su trenutno poznate timu. Njegova svrha je da omogući pregled planiranog obima sistema, olakša prioritizaciju rada po sprintovima i služi kao osnova za dalju razradu.

> **Napomena o ažuriranju Product Backloga:**  
> U Product Backlogu su ažurirani statusi stavki koje odgovaraju deliverable-ima **Sprinta 6**.  
> Konkretno, sljedeće stavke:
> - **Sprint Backlog**
> - **Drugi implementirani inkrement: dodavanje nove knjige, uređivanje podataka o knjizi, pregled kataloga, upravljanje primjercima knjige, brisanje knjige, upravljanje kategorijama knjige**
> - **Dokaz o testiranju**
> - **Decision Log**
> - **AI Usage Log**
> - **Sprint Retrospective Summary**
>
> Ove stavke su označene kao **završene u Sprintu 6**, jer predstavljaju artefakte koji su u ovom sprintu izrađeni.
