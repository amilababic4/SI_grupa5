...
Ovaj dokument predstavlja ažurirani Product Backlog projekta **Bibliotečki informacioni sistem** u sklopu Sprint 7. Backlog sadrži stavke koje su trenutno poznate timu. Njegova svrha je da omogući pregled planiranog obima sistema, olakša prioritizaciju rada po sprintovima i služi kao osnova za dalju razradu.

> **Napomena o ažuriranju Product Backloga:**  
> U Product Backlogu su ažurirani statusi stavki koje odgovaraju deliverable-ima **Sprinta 7**.  
> Konkretno, sljedeće stavke:
> - **Sprint Backlog**
> - **Treći implementirani inkrement: pretraživanje knjiga po nazivu, autoru te mogućnost kreiranja zaduženja od strane bibliotekara i admina**
> - **Dokaz o testiranju**
> - **Decision Log**
> - **AI Usage Log**
> - **Sprint Retrospective Summary**
>
> Ove stavke su označene kao **završene u Sprintu 7**, jer predstavljaju artefakte koji su u ovom sprintu izrađeni.
