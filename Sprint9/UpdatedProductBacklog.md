...
Ovaj dokument predstavlja ažurirani Product Backlog projekta **Bibliotečki informacioni sistem** u sklopu Sprint 9. Backlog sadrži stavke koje su trenutno poznate timu. Njegova svrha je da omogući pregled planiranog obima sistema, olakša prioritizaciju rada po sprintovima i služi kao osnova za dalju razradu.

> **Napomena o ažuriranju Product Backloga:**  
> U Product Backlogu su ažurirani statusi stavki koje odgovaraju deliverable-ima **Sprinta 9**.  
> Konkretno, sljedeće stavke:
> - **Sprint Backlog**
> - **Peti implementirani inkrement: rezervacija knjiga, pregled aktivnih rezervacija, napredba pretraga i filteri, automatsko otkazivanje rezervacija, mjesečni izvještaji, forum zajednica**
> - **Dokaz o testiranju**
> - **Decision Log**
> - **AI Usage Log**
> - **Sprint Retrospective Summary**
>
> Ove stavke su označene kao **završene u Sprintu 9**, jer predstavljaju artefakte koji su u ovom sprintu izrađeni.
...
| PB-45 | Mjesečni izvještaji za upravu | Pregled statistike zaduženja, rezervacija i članstva | Feature | Nizak | L | Završeno u Sprintu 9 | Sprint 10 | Analitika |
